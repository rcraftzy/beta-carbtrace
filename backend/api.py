...
@bp.route('/api/add-child', methods=['POST'])
@jwt_required()
def add_child():
    data = request.get_json()
    name = data['name']
...
@bp.route('/api/request', methods=['GET'])
@jwt_required()
def get_request():
...
@bp.route('/api/notification', methods=['GET'])
@jwt_required()
...
@bp.route('/api/notification/mark-all-as-read', methods=['PUT'])
@jwt_required()
...
@bp.route('/api/update_factor', methods=['PUT'])
@jwt_required()
def update_factor():
    data = request.get_json()
    current_user = get_jwt_identity()
...
@bp.route('/api/update_result', methods=['PUT'])
@jwt_required()
def update_result():
    data = request.get_json()
    current_user = get_jwt_identity()
...
@bp.route('/api/update_calculator_factor', methods=['PUT'])
...
@bp.route('/api/newmaterial', methods=['POST'])
@jwt_required()
def newmaterial():
    data = request.get_json()
...
@bp.route('/api/my-supplier', methods=['GET'])
@jwt_required() 
def get_my_supplier():
...
@bp.route('/api/my-products', methods=['GET'])
@jwt_required() 
def get_my_products():
    current_user = get_jwt_identity() 
...
@bp.route('/api/update-emissions', methods=['POST'])
@jwt_required()
...
@bp.route('/api/get-emissions', methods=['GET'])
@jwt_required()
...
@bp.route('/api/table-emissions', methods=['GET'])
@jwt_required() 
def table_emissions():
    current_user = get_jwt_identity() 
